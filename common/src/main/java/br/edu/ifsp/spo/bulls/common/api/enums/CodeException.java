...
public enum CodeException {
    ...
    GR007("GR005: Requester not authorized", "GR005"),
    DA001("DA001: Subscription date cannot be early than today", "DA001"),
    DA002("DA002: Subscription Final date cannot be early than Subscription date", "DA002"),
    DA003("DA003: Competition Final date cannot be early than Subscription final date", "DA003"),
    DA004("DA004: You cannot register before registration starts", "DA004"),
    DA005("DA005: You cannot register/ update history after the registration period", "DA005"),
    DA006("DA006: You cannot vote until registration ends ", "DA006"),
